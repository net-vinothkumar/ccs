...
class WebPageAnalyzeController @Autowired constructor(private val analyzer: Analyzer) {
    ...
    @PostMapping(value = arrayOf("/analyze"), consumes = arrayOf(MediaType.APPLICATION_JSON_UTF8_VALUE), produces = arrayOf(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    @GetMapping(value = arrayOf("/verifyLinks"))
